...
public class MyLogger {
		...
		// method created for start of test
		...
		// method created for end of test
		public static void endTestCase(String sTestCaseName) {
			info("\n\n************** Execution End : " + sTestCaseName + "**************\n");
		}

		//set the location for the logg file to be generated
		...
		//get the call info with details of class/method/line of failure
